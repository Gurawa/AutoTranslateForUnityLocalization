...
- Fixed Google free API fallback handling so translated words are collected correctly after both batch and fallback requests.
- Fixed saving empty translation results by skipping null or empty translated values before adding entries to localization tables.
